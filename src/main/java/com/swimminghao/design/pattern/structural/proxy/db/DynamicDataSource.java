package com.swimminghao.design.pattern.structural.proxy.db;
...
//	<bean id="dataSource" class="com.swimminghao.design.pattern.structural.proxy.db.DynamicDataSource">
